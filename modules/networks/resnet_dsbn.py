...
def resnet18dsbn(num_domains=2, pretrained=True, progress=True, **kwargs):
...
def resnet34dsbn(num_domains=2, pretrained=True, progress=True, **kwargs):
...
def resnet50dsbn(num_domains=2, pretrained=True, progress=True, **kwargs):
...
def resnet101dsbn(num_domains=2, pretrained=True, progress=True, **kwargs):
...
def resnet152dsbn(num_domains=2, pretrained=True, progress=True, **kwargs):
...
def resnext50_32x4d(num_domains=2, pretrained=True, progress=True, **kwargs):
...
def resnext101_32x8d(num_domains=2, pretrained=True, progress=True, **kwargs):
