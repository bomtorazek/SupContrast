...
from modules.networks.resnet_big import SupHybResNet, SupCEResNet, SupHybResNet2, MobileNetV2, CLIPResNet
...
def set_model(opt):
    ...
    if opt.method == 'Joint_Con':
        ...
        elif 'CLIP' in opt.model:
            training = opt.model.split('_')[1]
            model = CLIPResNet(training=training, num_classes=opt.num_cls)
    ...
    return model, criterion, preprocess
